...
In this laboratory, we employed an alpha spectrometer attached to a vacuum pump, a multichannel analyzer (MCA), a 0.1, and a computer with the software Maestro installed.
Further equipment details, where applicable, may be found in Appendix~\ref{app:equip}

\subsection{Setup}
\FloatBarrier
A system according to \figref{fig:Lab4_diag} was set up to observe alpha particle energy spectra from a given 
