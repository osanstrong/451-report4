...
\FloatBarrier
Using the simulated data of 5.486~MeV alpha ion transmission in dry air, aluminum, and Mylar, rough estimates of total stopping power $-dE/dx$, using an estimate of the derivative between adjacent measurements of energy $E$ and $x$
