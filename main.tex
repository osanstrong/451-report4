...
Likewise, we found stopping powers using TRIM data of air and Mylar in excess of SRIM stopping powers, while aluminum stopping powers were incalculable using experimental or TRIM data due to the thickness of aluminum used.
...
In this laboratory, the SRIM (Stopping and Range of Ions in Matter) and TRIM (Transport and Range of Ions in Matter, included within SRIM) codes will be used to generate these estimations.
...
\begin{figure}
    \centering\includegraphics[width=0.4\linewidth,angle=-90]{fig/Lab4_chamber.jpg}
...
\begin{figure}
    \centering\includegraphics[width=0.4\linewidth,angle=-90]{fig/Lab4_mylar.jpg}
...
\begin{figure}
    \centering\includegraphics[width=0.4\linewidth,angle=-90]{fig/Lab4_al.jpg}
