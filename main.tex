...
\figref{fig:vac_dists_v_nI} shows the integrated count rate for distances through vacuum, normalized by solid angle, compared to the original rates.\\
...
In Figs.\ref{fig:air_dist_v_I} through \ref{fig:air_dist_v_FWHM}, attenuation over distance in air can be observed through effects on integrated peak intensity (both gross and normalized rates), energy, and full width half maximum (FWHM) of energy peaks.\\
...
The attenuation through aluminum, shown by 
